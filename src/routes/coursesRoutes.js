...
router.get('/enrol', persistence, authorizeRole(['student']), coursesController.course_enrol_page);
router.get('/attend', persistence, authorizeRole(['student'], 'classId', '/courses/class'), coursesController.course_attend_page);
